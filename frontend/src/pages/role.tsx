      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-10 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {posts.map((post) => (
            <article
              key={post.id}
              className="flex flex-col items-start justify-between p-6 border rounded-xl shadow-sm hover:shadow-md transition cursor-pointer"
            ...
            >
              ...
              <div className="mt-6 w-full text-center">
                <button className="inline-block rounded-full bg-blue-600 px-6 py-3 text-white font-medium hover:bg-blue-700 transition">
                  Continue as →
                </button>
              </div>
            </article>
